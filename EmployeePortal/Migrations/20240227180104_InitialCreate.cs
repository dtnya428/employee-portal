        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryOffering = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SecondaryOffering = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Tribe = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeOffering", x => new { x.OfferingId, x.EmployeeId });
                    table.ForeignKey(
                        name: "FK_EmployeeOffering_Employees_EmployeeId",
