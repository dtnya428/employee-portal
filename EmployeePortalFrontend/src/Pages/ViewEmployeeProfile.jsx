          ...
          <Item className="emp_details_details">
            ...
            <Header as="h2">
              <HeaderContent>
                {responseData && (
                  <span>
                    {responseData.firstName} {responseData?.middleName}{" "}
            ...
            <Fragment>
              ...
              <Grid divided="vertically">
                <GridRow columns={isMobile ? 1 : 2}>
                  {typeof responseData.offerings !== "undefined" &&
                  responseData.offerings.length !== 0 ? (
                        ...
                        <GridColumn key={item.id}>
                          <Item className="item_container">
                            <Item className="offering_items">
                              ...
                              <Item>
                                {item.primaryOffering && (
                                  <span>
                                    <b>Primary Offering:</b>&nbsp;
                                    {item.primaryOffering}
                                  </span>
                                )}
                              </Item>
                              <Item>
                                {item.secondaryOffering && (
                                  <span>
                                    <b>Secondary Offering:</b>&nbsp;
                                    {item.secondaryOffering}
                                  </span>
                                )}
                              </Item>
